...
public sealed partial class CounterpartiesGroup : AppClientGroup
{
    ...
    public Task<EmptyActionResult> DeleteCounterparty(string modifier, int model, CancellationToken ct = default) => Actions.DeleteCounterparty.Post(modifier, model, ct);
