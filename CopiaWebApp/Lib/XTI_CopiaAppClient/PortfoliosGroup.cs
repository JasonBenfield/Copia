...
public sealed partial class PortfoliosGroup : AppClientGroup
{
    ...
    {
        Actions = new PortfoliosGroupActions(AddPortfolio: CreatePostAction<AddPortfolioRequest, PortfolioModel>("AddPortfolio"), GetPortfolios: CreatePostAction<EmptyRequest, PortfolioModel[]>("GetPortfolios"));
    }
    ...
    public sealed record PortfoliosGroupActions(AppClientPostAction<AddPortfolioRequest, PortfolioModel> AddPortfolio, AppClientPostAction<EmptyRequest, PortfolioModel[]> GetPortfolios);
}