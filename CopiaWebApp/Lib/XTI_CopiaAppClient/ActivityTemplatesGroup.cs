...
public sealed partial class ActivityTemplatesGroup : AppClientGroup
{
    ...
    public Task<ActivityTemplateModel> AddActivityTemplate(string modifier, AddActivityTemplateRequest model, CancellationToken ct = default) => Actions.AddActivityTemplate.Post(modifier, model, ct);
