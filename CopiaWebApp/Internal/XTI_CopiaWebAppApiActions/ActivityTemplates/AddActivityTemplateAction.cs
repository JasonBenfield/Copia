...
namespace XTI_CopiaWebAppApiActions.ActivityTemplates;

public sealed class AddActivityTemplateAction : AppAction<AddActivityTemplateRequest, ActivityTemplateModel>
{
